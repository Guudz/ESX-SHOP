...
ESX.RegisterUsableItem('wine', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onDrink', source)
	TriggerClientEvent('t1ger_trafficpolicer:useAlcohol', xPlayer.source, 70)  --14 de base
...
ESX.RegisterUsableItem('beer', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'drunk', 200000)
	TriggerClientEvent('esx_basicneeds:onDrink', source)
	TriggerClientEvent('t1ger_trafficpolicer:useAlcohol', xPlayer.source, 50) --14 de base
...
TriggerEvent('es:addGroupCommand', 'heal', 'admin', function(source, args, user)
	...
	if args[1] then
		...
		if target ~= nil then
			...
			if GetPlayerName(target) then
				print('' .. GetPlayerName(source) .. ' est soigné!')
			...
			TriggerClientEvent('chatMessage', source, "HEAL", {255, 0, 0}, "Erreur de commande! Il faut saisir un ID valide!")
		end
	else
		-- heal source
		print('' .. GetPlayerName(source) .. ' est soigné!')
	...
	TriggerClientEvent('chatMessage', source, "HEAL", {255, 0, 0}, "Vous n'avez pas la permission.")
end, {help = "Soigner un joueur / restaurer la faim et la soif."})